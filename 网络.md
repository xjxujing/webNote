...
###   监控数据
  ...
  `readyState`五种状态     状态发生**变化**的时候会触发`readystatechange`事件
...
~~~javascript
Content-Type 实体主体的媒体类型   "content-type": "appliction/json"
...
2.链路层	内网寻址，家庭网 手机和路由器	ARP   ICMP
